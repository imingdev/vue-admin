<template>
  <div class="panel">
    <panel-title title="添加保险头条"></panel-title>
...
<script type="text/javascript">
  import {url_file_upload, url_add_insurance_headline, API_SUCCESS} from 'common/URL'
      ...
      onSubmit(){
        this.$refs.form.validate((valid) => {
          if (valid) {
            let _data = this.form
            this.on_submit = true
            this.$http.post(url_add_insurance_headline, {
              title: _data.title,
              descip: _data.descip,
              url: _data.url,
